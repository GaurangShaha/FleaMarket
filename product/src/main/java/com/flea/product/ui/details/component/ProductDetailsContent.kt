...
import com.flea.product.ui.details.ProductDetailsIntent
...
internal fun ProductDetailsContent(
    state: ProductDetailsUiState.Content,
...
private fun ContentForMediumAndExpandedScreen(
    state: ProductDetailsUiState.Content, handleIntent: (ProductDetailsIntent) -> Unit
) {
