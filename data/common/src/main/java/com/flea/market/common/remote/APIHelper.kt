...
inline fun <E, M> request(
    onSuccess: (
        httpCode: Int, headers: Headers, responseEntity: E
    ) -> M = { _, _, responseEntity -> responseEntity as M },
    onError: (
        errorCode: Int, headers: Headers, errorBodyBuffer: BufferedSource?
    ) -> Throwable = { _, _, _ -> RemoteException() }, call: () -> Response<E>
